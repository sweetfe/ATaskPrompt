...
- `onTrophyUnlock`: Function called when new trophy is earned
...
**Methods**:
- `unlockTrophy(trophy)`: Process trophy unlocking
- `showTrophyAnimation()`: Display trophy earned animation
- `calculateProgress()`: Determine progress toward next trophy
...
- Left Swipe: Skip/Decline task
- Right Swipe: Accept/Complete task
